    ...
    <main className='!pt-0'>
        ...
        <div className='flex flex-row w-full max-lg:flex-col-reverse'>
            <section className="feedback-section bg-[url('/images/bg-small.svg') bg-cover h-[100vh] sticky top-0 items-center justify-center">
                {imageUrl && resumeUrl &&(
                    <div className='animate-in fade-in duration-1000 gradient-boder max-sm:m-0 h-[90%] max-wxl:h-fir w-fit'>
            ...
            <section className='feedback-section '>
                ...
                '>Resume Review</h2>
                {feedback ? (
                    <div className='flex flex-col gsp-8 animate-in fade-in duration-1000'>
